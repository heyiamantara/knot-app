  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <button className="bg-neo-secondary text-white font-mono-label text-mono-label px-8 py-4 uppercase hover:bg-black transition-none border-standard border-black">
          CREATE THREAD
        </button>
      </DialogTrigger>
